        ...
        if (this.state.isLoaded) {
                    ...
                    case 'date':
                        return (
                            <tr>
                                ...
                                <td>
                                    <InputText className={"p-inputtext"} type="date" value={this.state.data[element.field_name]} onChange={this.onFieldChange(element.field_name)} max={getTodayDate()}/>
                    ...
                    case 'date_plus_checkbox':
                        return (
                            <tr>
                                ...
                                <td>
                                    <InputText className={"p-inputtext"} type="date" value={this.state.data[element.field_name]} max={getTodayDate()} onChange={this.onFieldChange(element.field_name)} disabled={this.state.data[element.checkbox.field_name] === '1'} />
            ...
            return (
                <dev>
                    ...
                    {!this.props.viewOnly &&
                    <p><Button className={"p-button"} style={{backgroundColor: "hotpink", fontSize: "large"}} label="Submit" onClick={this.onClickSubmit} /></p>
                    }
                </dev>
            );
        }
